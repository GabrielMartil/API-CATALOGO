...
var CreateCustomerService = /** @class */ (function () {
    ...
    CreateCustomerService.prototype.execute = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var configuracao;
            var name_loja = _b.name_loja, whatsapp_num = _b.whatsapp_num, instagram_name = _b.instagram_name, whatsapp_status = _b.whatsapp_status, instagram_status = _b.instagram_status;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prisma_1.default.configuracao.create({
                                data: {
                                    name_loja: name_loja,
                    ...
                    case 1:
                        configuracao = _c.sent();
                        return [2 /*return*/, configuracao];
                }
            });
        });
    };
